  ...
  return (
    ...
    >
      <span className="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-md bg-white/10 text-white/90 leading-none">
        <FaYelp className="w-4 h-4 block" />
      </span>
